...
public class ComponentsManager implements Serializable {
	 ...
	 * 
	 * @deprecated Use {@link ComponentsManager#ComponentsManager(PageNumberProvider, int, int, int, ElementsCustomizer, StyleCustomizer, PagingComponent)} to provide the inital page number
	 * 
	 */
	@Deprecated
	public ComponentsManager(int numberOfItemsPerPage, int numberOfButtonsPage, int numberTotalOfItems, ElementsCustomizer elementsCustomizer, StyleCustomizer styleCustomizer, PagingComponent<?> pagingComponent) {
		this(PageNumberProviderFactory.firstPage(), numberOfItemsPerPage, numberOfButtonsPage, numberTotalOfItems, elementsCustomizer, styleCustomizer, pagingComponent);
	}
	 ...
	 * @param pagingComponent the {@link PagingComponent} to manage
	 */
	public ComponentsManager(PageNumberProvider pageNumberProvider, int numberOfItemsPerPage, int numberOfButtonsPage, int numberTotalOfItems, ElementsCustomizer elementsCustomizer, StyleCustomizer styleCustomizer, PagingComponent<?> pagingComponent) {
		...
		currentPage = pageNumberProvider.getPageNumber(numberTotalOfPages);
		previousPage = -1;
